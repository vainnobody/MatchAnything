...
def load_config(config_name: str) -> Dict[str, Any]:
    return load_runtime_config(config_name)
...
def parse_match_config(conf):
    ...
    raise RuntimeError(
        "Sparse matcher configs were moved to legacy and are not part of the default runtime."
    )
...
def get_feature_model(conf: Dict[str, Dict[str, Any]]):
    raise RuntimeError(
        "Feature extraction models were moved to legacy. Use the API extract endpoint for the lightweight runtime."
    )
